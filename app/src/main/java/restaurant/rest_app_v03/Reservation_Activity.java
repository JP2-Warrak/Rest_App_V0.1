package restaurant.rest_app_v03;
...
public class Reservation_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, final int postion, long l) {
                ...
                new AlertDialog.Builder(Reservation_Activity.this)
                        .setTitle("Select your option")
                        .setMessage("......")
                        .setPositiveButton("Edit",new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                Intent intent=new Intent(Reservation_Activity.this,MainActivity.class);
                                intent.putExtra("ID_Res",ids[postion]);
                                intent.putExtra("ID_Client",names[postion]);
                                intent.putExtra("Nombre de Repas",emails[postion]);
                                intent.putExtra("Date de la réservation",mobiles[postion]);
                                intent.putExtra("Heure de la réservation",mobiles[postion]);
    ...
    class DisplayAllTask extends AsyncTask<String,String,String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            JSONObject jsonObject=JSONParser.makeHttpRequest("http://dacie.fr/tests/resto/PHP/display_all.php","POST",list);
    ...
    class DeleteTask extends AsyncTask<String,String,String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            JSONObject jsonObject=JSONParser.makeHttpRequest("http://dacie.fr/tests/resto/PHP/delete_student.php","POST",list);
